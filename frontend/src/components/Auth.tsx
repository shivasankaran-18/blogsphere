...
import { signupInput } from "@shiva_18/common";
            ...
            <div>
                <div className="px-10">
                    <div className="text-3xl font-extrabold">
                        {type=="signin" ? "Sigin To Your Account " : "Create an Account"}
                    </div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Shiva.." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Email" placeholder="shiva@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
